# This Python script batch edits a directory with multiple subdirectories containing XML files. 
# The script renames all JPG files within each subdirectory so that the XML file name is prefixed with 
# the immediate folder name followed by an underscore and ending with the original XML name. The script 
...
def get_input_directory():
    root = tk.Tk()
    root.withdraw()
    input_directory = filedialog.askdirectory(title='Select the input xml directory to edit')
